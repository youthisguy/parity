...
export function DashboardClient() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
          ...
          >
            ...
            <span
              className={`ml-1.5 text-[10px] font-normal ${
                selected.perp === s.perp ? "text-cyan-400/70" : "text-slate-600"
              }`}
            >
              {s.name}
            </span>
      ...
      <section className="bg-slate-900/40 border border-[#161616]/80 rounded-xl overflow-hidden shadow-2xl shadow-black/40 backdrop-blur-sm">
        <div className="border-b border-[#161616] px-6 py-4 flex items-center justify-between bg-[#161616]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <section className="lg:col-span-5 bg-slate-900/40 border border-[#161616]/80 rounded-xl overflow-hidden flex flex-col shadow-xl">
          <div className="border-b border-[#161616] px-5 py-4 bg-[#161616]">
            <h2 className="text-xs font-bold text-slate-400 uppercase tracking-wider">
              Dislocation Leaderboard
            </h2>
            <p className="text-[11px] text-slate-600 mt-0.5">
              All symbols · ranked by avg z-score
            </p>
          </div>
          <div className="p-5 flex-1 bg-[#161616]">
            <Leaderboard />
          </div>
        </section>

        <section className="lg:col-span-7 bg-slate-900/40 border border-[#161616]/80 rounded-xl overflow-hidden flex flex-col shadow-xl">
          <div className="border-b border-[#161616] px-5 py-4 bg-[#161616] flex items-center justify-between">
            <div>
              <h2 className="text-xs font-bold text-slate-400 uppercase tracking-wider">
                Recent Divergence Events
              </h2>
              <p className="text-[11px] text-slate-600 mt-0.5">
                All symbols · simulated P&L included
              </p>
            </div>
          ...
          <div className="p-5 max-h-[460px] overflow-y-auto bg-[#161616]">
            <DivergenceFeed />
          </div>
        </section>
      </div>
